    ...
    @if(\Illuminate\Support\Facades\Session::has('success'))
        @if(\Illuminate\Support\Facades\Session::get('success') == 'true')
            <script type="text/javascript">
                const buttons = `<a class="btn btn-outline-primary float-left" href="{{route('artists.index')}}">
                    <span class="row">
                ...
                <a href="{{route('upload.page',['type'=>\App\Models\Artist::class,'id'=>$artist->id,'edit'=>1])}}" id="continue" class="btn btn-outline-primary float-right">
                    <span class="row">
                            Go to Media section
