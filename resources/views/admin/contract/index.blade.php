            ...
            <div class="row">
                <div class="card col-sm-12">
                    <div class="card-header">
                        <a href="{{route('contracts.create')}}" type="button" class="btn btn-success mr-2 float-right"> <i
...
@section('scripts')
    ...
    <script>
        ...
        $(".delete-icon").on("click", function () {
            ...
            $("#delete-form").attr("action", "/contracts/" + ContractId)
        });

    </script>
    <script>
        function deleteModal(element) {
            var ContractId = $(element).data('id');

            document.getElementById('delete-form').action = "/contracts/" + ContractId;
            Swal.fire({
                icon: 'warning',
